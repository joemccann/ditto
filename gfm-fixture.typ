...
Plain autolink: #link("https://example.com")

Angle-bracket autolink: #link("https://www.rust-lang.org")

Email autolink: #link("mailto:user@example.com", [user\@example.com])

Explicit link (should keep label): #link("https://github.com", [GitHub])
...
== Combined: Strikethrough + Inline Elements <combined-strikethrough-inline-elements>
...
This is a blockquote. It supports #strong[formatting] and #emph[emphasis].
